package com.androidjp.anim_demo.animation;
...
public class CustomViewAnim extends Animation {
    ...
    public CustomViewAnim(float mFromDegrees, float mToDegrees, float mCenterX, float mCenterY, float mDepthZ, boolean mReverse) {
